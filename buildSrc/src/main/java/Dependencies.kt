...
//        const val crashLytic = "com.google.firebase:firebase-crashlytics:17.1.0"
    ...
    object Compose {
        const val compose1 = "androidx.compose.ui:ui:${Versions.compose}"
        const val compose2=  "androidx.compose.material:material:${Versions.compose}"
        const val compose3 = "androidx.ui:ui-tooling:${Versions.compose}"
    }
}
